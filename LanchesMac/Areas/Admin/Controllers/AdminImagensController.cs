...
public class AdminImagensController : Controller
{
    ...
    public async Task<IActionResult> UploadFiles(List<IFormFile> files)
    {
        ...
        var filePath = Path.Combine(_webHostEnvironment.WebRootPath, _myConfig.NomePastaImagensProduto);
    ...
    public IActionResult GetImagens()
    {
        ...
        var userImagesPath = Path.Combine(_webHostEnvironment.WebRootPath, _myConfig.NomePastaImagensProduto);
    ...
    {
        string imagemDeleta = Path.Combine(_webHostEnvironment.WebRootPath, _myConfig.NomePastaImagensProduto + "\\", fname);
